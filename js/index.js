...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate('|食用说明|1:请阅读完文案|之后|点击下方虫洞|2:不允许|选第二个(怒)|3:网页自带|音乐|戴上耳机|效果更佳|\
                  下面|开始吧！|#countdown 5|时光匆匆|又到了这一天|首先|祝福|吴亚男老师|生日|快|乐|天天|开|心|!!!|\
                  在去年|vbot|是否|送来了温暖呢|浩瀚的星空|闪烁着|点点的荧光|每一丝亮光|都承载|绮丽的梦想|\
                  今年|虽仍远在|太阳系以外|不能亲自到场|但vbot|以自己|最大的努力|将星系|装进屏幕中|\
                  希望你能|喜欢|那么|做好准备了吗?|虫洞已经打开|通往明年的路上|繁星与你|始终作伴|!!!!!|#rectangle|');
    }
